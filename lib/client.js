  ...
  factory: function(require) {
    ...
    exports.apply = function(ctx) {
      ...
      function saveTranscriptToHost(text) {
        ...
        // Fallback: try host.call if settings.update is not available
        if (!settings || typeof settings.update !== 'function') {
          try {
            if (typeof host !== 'undefined' && host && typeof host.call === 'function') {
              host.call('settings.update', { ns: 'meeting-notes', patch: { _transcript: text, _timestamp: Date.now() } })
            }
          } catch (e2) {}
        }
      }
      ...
      function triggerFinalSummary(fullText) {
        ...
        if (!settings || typeof settings.update !== 'function') {
          try {
            if (typeof host !== 'undefined' && host && typeof host.call === 'function') {
              host.call('settings.update', { ns: 'meeting-notes', patch: { _finalTranscript: fullText, _timestamp: Date.now() } })
            }
          } catch (e2) {}
        }
      }
