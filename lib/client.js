  ...
  factory: function(require) {
    ...
    exports.apply = function(ctx) {
      ...
      function saveTranscriptToHost(text) {
        if (hostApi) {
          try {
            hostApi.call('settings.update', { ns: 'meeting-notes', patch: { _transcript: text, _timestamp: Date.now() } })
          } catch (e) {}
        }
      }
      ...
      function triggerFinalSummary(fullText) {
        if (hostApi) {
          try {
            hostApi.call('settings.update', { ns: 'meeting-notes', patch: { _finalTranscript: fullText, _timestamp: Date.now() } })
          } catch (e) {}
        }
      }
