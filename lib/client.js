window.__ModuleLoader__.load({
  ...
  factory: function(require) {
    ...
    exports.apply = function(ctx) {
      ...
      slots.inject('settings.section', function() { return slots.register({ name:'settings.section', id:'meeting-notes', order:50 }, function(p) { return React.createElement(MeetingNotesSettings, { close:p.close }) }) })
