window.__ModuleLoader__.load({
  ...
  factory: function(require) {
    ...
    exports.apply = function(ctx) {
      ...
      var hostApi = typeof host !== 'undefined' && host && typeof host.call === 'function' ? host : null
      ...
      function saveTranscriptToHost(text) {
        if (hostApi) {
          try {
            hostApi.call('settings.update', ['meeting-notes', { _transcript: text, _timestamp: Date.now() }, undefined])
          } catch (e) {}
        }
      }
      ...
      function triggerFinalSummary(fullText) {
        if (hostApi) {
          try {
            hostApi.call('settings.update', ['meeting-notes', { _finalTranscript: fullText, _timestamp: Date.now() }, undefined])
          } catch (e) {}
        }
      }
